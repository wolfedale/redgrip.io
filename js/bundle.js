function validateFormOnSubmit(theForm) {
      ...
      xhr.open("POST", "https://d37ukn5es9.execute-api.eu-central-1.amazonaws.com/sendMail");
      ...
      //xhr.send(JSON.stringify({
      //    name: theForm.clientName.value,
      //    email: theForm.clientEmail.value,
      //}));

      //console.log(theForm.clientName.value)
      //console.log(xhr);
